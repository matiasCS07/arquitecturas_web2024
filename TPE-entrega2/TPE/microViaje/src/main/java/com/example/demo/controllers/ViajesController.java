...
public class ViajesController {
	...
	@GetMapping("/pausa/{id}")
	public ResponseEntity<Duration> getPausasById(@PathVariable long id){
		try {
			Duration result=this.viajeSer.getPausasById(id);
	...
	@PostMapping("/añadir/{idUsuario}/{idMonopatin}")
	public ResponseEntity<?> createViaje(@PathVariable @Valid long idUsuario, @PathVariable long idMonopatin){
		try {
	...
	public ResponseEntity<?> finalizarViaje(@PathVariable long id, @RequestParam @Valid double latitud, @RequestParam @Valid double longitud){
		try {
