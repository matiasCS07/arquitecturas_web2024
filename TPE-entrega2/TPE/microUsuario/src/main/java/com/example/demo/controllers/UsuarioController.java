...
public class UsuarioController {
	...
	public ResponseEntity<ViajeResponseDTO> activarMonopatin(@RequestParam @Valid double latitud, @RequestParam @Valid double longitud, @RequestParam @Valid long id){
		try {
	...
	public ResponseEntity<?> ubicarMonopatin(@RequestParam @Valid double latitud, @RequestParam @Valid double longitud, @PathVariable long idViaje){
		try {			
