...
public class MonopatinController {
	...
	public ResponseEntity<MonopatinResponseDTO> cambiarMonopatinMantenimiento(@PathVariable long id, @RequestBody @Valid String estado, boolean habilitado){
		try {
	...
	@GetMapping("/cercanos")
	public ResponseEntity<MonopatinResponseDTO> getAllMonopatinesCercanos(@RequestBody @Valid double latitud, double longitud){
		try {
