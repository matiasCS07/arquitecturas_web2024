...
public class AdministradorController {
	...
	public ResponseEntity<Tarifa> getTarifa() {
		Tarifa tarifa=this.adminSer.getTarifa();
		if(tarifa==null) {
	...
	public ResponseEntity<List<MonopatinResponseDTO>> getAllMonopatinesCercanos(@RequestBody @Valid double latitud, double longitud){
		try {
	...
	public ResponseEntity<MonopatinResponseDTO> getMonopatinCercano(@RequestBody @Valid double latitud, double longitud){
		try {
	...
	public ResponseEntity<?> cambiarMonopatinEnMantenimiento(@PathVariable long id, @RequestBody @Valid String estado, boolean habilitado){
		try {
